...
export const products = [
  {
    ...
    category: "nauseas",
    description:
      "Para que serve Cloridrato de Ondansetrona? Adultos: O cloridrato de ondansetrona é indicado para o controle de náuseas e vômitos induzidos por quimioterapia e radioterapia. Também é indicado para prevenção de náuseas e vômitos do período pós-operatório.",
  ...
  },
  {
    ...
    category: "sono-e-ansiedade",
    description:
      "Sedatif PC é um medicamento homeopático que é comumente utilizado para aliviar sintomas associados a estresse, ansiedade leve e distúrbios do sono. É promovido como uma opção não sedativa e, portanto, não deve causar sonolência.",
